...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='measure',
            field=models.IntegerField(choices=[(0, 'Gram'), (1, 'Spoon'), (2, 'Teaspoon'), (3, 'Cup'), (4, 'Pitch'), (5, 'Handful'), (6, 'Tuft'), (7, 'Spring'), (8, 'Leaf'), (9, 'Piece')]),
        ),
        migrations.AlterField(
            model_name='recipes',
            name='type',
            field=models.IntegerField(choices=[(0, 'Soup'), (1, 'Main Dish'), (2, 'Salat'), (3, 'Omlet'), (4, 'Fricassee')]),
        ),
        migrations.AlterField(
